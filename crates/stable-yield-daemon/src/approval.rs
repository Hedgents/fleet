//! Manual-approval queue for AssignStableLend.
//!
...
//! the (conversation_id, AssignStableLend, sender_pubkey) tuple, emits
...
pub struct ApprovalQueue {
    ...
    pending: Mutex<HashMap<[u8; 16], (AssignStableLend, Instant, [u8; 32])>>,
}
...
impl ApprovalQueue {
    ...
    pub fn enqueue(&self, conv: [u8; 16], assign: AssignStableLend, sender: [u8; 32]) -> bool {
